...
const dictionaries = {
  en: {
    ...
    "action.loadAdditionalModel": "Add Character...",
    "action.loadAdditionalModelFolder": "Add Character From Folder...",
    "action.clearAdditionalModel": "Clear Added Character",
    "action.pose": "Pose...",
  ...
  ja: {
    ...
    "action.loadAdditionalModel": "キャラクターを追加...",
    "action.loadAdditionalModelFolder": "フォルダからキャラクターを追加...",
    "action.clearAdditionalModel": "追加キャラクターをクリア",
    "action.pose": "ポーズ...",
  ...
  zh: {
    ...
    "action.loadAdditionalModel": "添加角色...",
    "action.loadAdditionalModelFolder": "从文件夹添加角色...",
    "action.clearAdditionalModel": "清除添加的角色",
    "action.pose": "姿势...",
