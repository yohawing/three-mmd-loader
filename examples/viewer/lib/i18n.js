...
const dictionaries = {
  en: {
    ...
    "aria.audioOffsetFrame": "Audio start frame",
    ...
    "viewport.grid": "Grid",
    "viewport.axes": "Axis",
    "audio.offsetFrame": "Audio Start Frame",
    "action.save": "Save",
    "action.load": "Load",
  ...
  ja: {
    ...
    "aria.audioOffsetFrame": "音声開始フレーム",
